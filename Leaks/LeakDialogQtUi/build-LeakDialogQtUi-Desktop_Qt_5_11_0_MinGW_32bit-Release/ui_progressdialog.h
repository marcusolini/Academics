...
public:
    ...
    {
        ProgressDialog->setWindowTitle(QApplication::translate("ProgressDialog", "Resource Leak Tests~~~~~", nullptr));
        RunTestsLabel->setText(QApplication::translate("ProgressDialog", "Starting Leak Tests...~~~~", nullptr));
        StopPushButton->setText(QApplication::translate("ProgressDialog", "Stop~~~~", nullptr));
        PausePushButton->setText(QApplication::translate("ProgressDialog", "Pause~~~~", nullptr));
    } // retranslateUi
